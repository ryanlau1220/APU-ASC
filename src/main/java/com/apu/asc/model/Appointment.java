...
public class Appointment {
    ...
    public Appointment(String appointmentId, String customerId, String counterStaffId,
                       String technicianId, String serviceId, String vehiclePlate,
                       LocalDateTime appointmentDateTime, ApptStatus status, String technicianNotes) {
    ...
    public String toFileString() {
        return String.join("||", appointmentId, customerId, counterStaffId,
                technicianId, serviceId, vehiclePlate,
                appointmentDateTime.toString(), status.name(), technicianNotes);
    }
}
