...
public class Payment {
    ...
    public Payment(String paymentId, String appointmentId, double amountPaid,
                   LocalDateTime paymentDateTime, boolean receiptSent) {
    ...
    public void markReceiptSent() { this.receiptSent = true; }

    public String toFileString() {
        return String.join("||", paymentId, appointmentId,
                String.valueOf(amountPaid), paymentDateTime.toString(),
