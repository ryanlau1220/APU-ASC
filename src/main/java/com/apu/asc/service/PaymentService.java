...
public class PaymentService {
    ...
    public Payment processPayment(String appointmentId) {
        ...
        Payment payment = new Payment(id, appointmentId, service.getPrice(),
                LocalDateTime.now(), false);
        paymentDAO.save(payment);
        SystemLogger.log(actorId(), "PROCESS_PAYMENT", id,
    ...
    public boolean sendReceipt(String paymentId) {
        ...
        try {
            ...
            SystemLogger.log(actorId(), "SEND_RECEIPT", payment.getPaymentId(),
    ...
    private Path generateReceiptPdf(Payment payment, Appointment appt,
                                    User customer, Service service) throws Exception {
        ...
        addRow(table, "Date",          payment.getPaymentDateTime()
