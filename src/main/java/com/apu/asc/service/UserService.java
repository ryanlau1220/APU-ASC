...
public class UserService {
    ...
    public User createUser(Role role, String username, String rawPassword,
        ...
        SystemLogger.log(actor, "CREATE_USER", id,
    ...
    public boolean updateProfile(User user, String fullName, String email, String contactNumber) {
        ...
        userDAO.save(user);
        SystemLogger.log(actorId(), "UPDATE_PROFILE", user.getId(),
    ...
    public boolean deactivateUser(String userId) {
        ...
        SystemLogger.log(actorId(), "DEACTIVATE_USER", userId,
    ...
    public boolean reactivateUser(String userId) {
        ...
        userDAO.save(user);
        SystemLogger.log(actorId(), "REACTIVATE_USER", userId,
    ...
    private User buildUser(Role role, String id, String username, String hash,
                            String fullName, String email, String contactNumber) {
        return switch (role) {
            case CUSTOMER     -> new Customer(id, username, hash, UserStatus.ACTIVE, fullName, email, contactNumber);
            case STAFF        -> new CounterStaff(id, username, hash, UserStatus.ACTIVE, fullName, email, contactNumber);
            case TECHNICIAN   -> new Technician(id, username, hash, UserStatus.ACTIVE, fullName, email, contactNumber);
            case MANAGER      -> new Manager(id, username, hash, UserStatus.ACTIVE, fullName, email, contactNumber);
        };
    }
