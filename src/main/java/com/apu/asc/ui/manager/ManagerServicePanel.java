...
public class ManagerServicePanel extends JPanel {
    ...
    private void loadData() {
        ...
        for (Service s : services) {
            model.addRow(new Object[]{
                s.getServiceId(), s.getType().name(), s.getServiceName(),
                String.format("%.2f", s.getPrice()), s.isActive() ? "Yes" : "No"
            });
        }
    }
    ...
    private void handleEditPrice() {
        ...
        if (row < 0) { JOptionPane.showMessageDialog(this, "Select a service first."); return; }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Invalid price. Enter a positive number.",
