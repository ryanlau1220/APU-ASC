...
public class StaffAssignPanel extends JPanel {
    ...
    private void loadData() {
        ...
        for (Appointment a : pending) {
            ...
            model.addRow(new Object[]{
                ...
                a.getServiceId(), a.getAppointmentDateTime().format(fmt), a.getStatus().name()
            });
        }
    }
    ...
    private void handleAssign() {
        ...
        String[] names = technicians.stream()
                .map(t -> t.getFullName() + " (" + t.getId() + ")")
                .toArray(String[]::new);

        String chosen = (String) JOptionPane.showInputDialog(this,
                "Select Technician:", "Assign Technician",
        ...
        if (!ok) {
            JOptionPane.showMessageDialog(this,
                    "Assignment failed: technician has a schedule conflict.", "Error",
