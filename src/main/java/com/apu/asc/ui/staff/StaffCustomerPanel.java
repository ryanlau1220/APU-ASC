...
public class StaffCustomerPanel extends JPanel {
    ...
    private void openAddDialog() {
        ...
        int res = JOptionPane.showConfirmDialog(this, p, "Add Customer",
                JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
        if (res != JOptionPane.OK_OPTION) return;

        User created = userService.createUser(Role.CUSTOMER,
                username.getText(), new String(pass.getPassword()),
                fullName.getText(), email.getText(), contact.getText());
    ...
    private void openEditDialog() {
        ...
        int res = JOptionPane.showConfirmDialog(this, p, "Edit Customer",
                JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
        if (res != JOptionPane.OK_OPTION) return;
