...
public class SystemLogger {
    ...
    public static void log(String userId, String actionType, String targetEntityId, String description) {
        String logId = "LOG-" + UUID.randomUUID().toString().substring(0, 8).toUpperCase();
        String line = String.join("||", logId, LocalDateTime.now().toString(),
                userId, actionType, targetEntityId, description);
